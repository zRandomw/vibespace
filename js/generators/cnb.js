...
function generateCnbYml(config) {
  ...
  if (config.ossEnabled) {
    ...
    lines.push(`        OSS_PATHS: "${config.ossPaths || '/root/.ssh,/root/.claude,/root/.codex,/root/.agents,/root/.cc-switch,/root/.local/share/code-server/User/globalStorage,/root/.vscode-server/data/User/globalStorage'}"`);
